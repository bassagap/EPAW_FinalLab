...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<ul>
			<li class="Login"><div class="user-image"
		...
		$(document)
				.ready(
						function() {
							$(".Register")
									.click(
											function() {
												$
														.ajax({
															url : '${pageContext.request.contextPath}/views/accessManagement/ViewRegisterForm.jsp',
															type : "POST",
															data : {
							...
							$
									.ajax({
										url : '${pageContext.request.contextPath}/views/accessManagement/ViewLoginForm.jsp',
										type : "POST",
										data : {
											userName : '${user.userName}',
											error : '${user.error[0]}'
